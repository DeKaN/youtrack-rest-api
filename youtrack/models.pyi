...
class Connection:
    ...
    def _get(self, path: str, params: Params = None, **kwargs: Any): ...

    def _post(self, path: str, data: Data = None, params: Params = None, **kwargs: Any): ...

    def _put(self, path: str, data: Data = None, params: Params = None, **kwargs: Any): ...

    def _create_object(self, cls: Type[YO], data) -> YO: ...
    ...
    def get_issues_count(self, filters: str = '', retry_delay: int = 5, wait_answer: bool = True) -> int: ...

    def get_project_issues(self, project_id: str, filters: List[str] = [], count: int = 10, after: int = 0,
                           updated_after: datetime = None, wikify_desc: bool = False) -> List[Issue]: ...

    def get_issues(self, filters: List[str] = [], with_fields: List[str] = [], count: int = 10, after: int = 0) -> \
            Union[List[Issue], Dict[str, Union[str, List[Issue]]]]: ...

    def get_issue(self, issue_id: str) -> Issue: ...

    def create_issue(self, project_id: str, summary: str, description: str = '', attachments: Dict[str, BinaryIO] = {},
...
class Project(YoutrackObject):
    def get_issues(self, filters: List[str] = [], count: int = 10, after: int = 0, updated_after: datetime = None,
                   wikify_desc: bool = False) -> List[Issue]: ...

    def create_issue(self, summary: str, description: str = '', attachments: Dict[str, BinaryIO] = {},
                     **kwargs: Any) -> requests.Response: ...
...
class Issue(YoutrackObject):
    ...
    def create_attachment(self, filename: str, data: BinaryIO, author: str = None, created: datetime = None,
